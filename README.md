- [Java - Platform Independent (WORA - Write Once Run Anywhere)](#java---platform-independent-wora---write-once-run-anywhere)
- [JDK vs JRE vs JVM](#jdk-vs-jre-vs-jvm)
- [Advantage of this model](#advantage-of-this-model)
- [JIT - Just In Time Compiler](#jit---just-in-time-compiler)
- [Five design goals of Java](#five-design-goals-of-java)
- [Compiling \& Running a Java program without an IDE](#compiling--running-a-java-program-without-an-ide)
- [JShell](#jshell)
- [Disecting a Java Program](#disecting-a-java-program)
- [Variable declaration and assignment](#variable-declaration-and-assignment)
- [Primitive types](#primitive-types)
- [Literals](#literals)
- [Strong static typing](#strong-static-typing)
- [Type casting](#type-casting)
- [Casting and lossy conversion](#casting-and-lossy-conversion)
- [Precision loss in numeric operations](#precision-loss-in-numeric-operations)
- [Automatic Type Promotion](#automatic-type-promotion)
- [Arrays](#arrays)
- [Multidimensional Arrays](#multidimensional-arrays)
- [Operators](#operators)
- [Blocks and Variable Scoping](#blocks-and-variable-scoping)
- [Flow/ Control Statements](#flow-control-statements)
- [Revisiting variable scoping](#revisiting-variable-scoping)
- [Object Oriented Programming](#object-oriented-programming)
- [Class Syntax and Object creation](#class-syntax-and-object-creation)
- [Object references](#object-references)
- [Things to remember](#things-to-remember)
- [Variable Shadowing and this reference](#variable-shadowing-and-this-reference)
- [Constructors](#constructors)
- [Calling a Constructor from Constructor](#calling-a-constructor-from-constructor)
- [Instance arguments and copy constructors](#instance-arguments-and-copy-constructors)
- [Constructor Object Argument](#constructor-object-argument)
- [Copy Constructor Pattern](#copy-constructor-pattern)
- [Passing objects as method arguments](#passing-objects-as-method-arguments)
- [Packages](#packages)
...
- [Local classes and variable scope :](#local-classes-and-variable-scope-)
- [Inheritance and Polymorphism](#inheritance-and-polymorphism)
- [Method Overriding](#method-overriding)
- [Inheritance Example](#inheritance-example)
- [Encapsulation revisited](#encapsulation-revisited)
- [Constructors calls with Inheritance](#constructors-calls-with-inheritance)
- [Abstract Class](#abstract-class)
- [Abstract Methods](#abstract-methods)
- [Final Keyword with Inheritance](#final-keyword-with-inheritance)
- [Interfaces](#interfaces)
- [Usage of Interfaces](#usage-of-interfaces)
- [Default Methods in Interfaces](#default-methods-in-interfaces)
- [Interfaces Summary](#interfaces-summary)
...
- [Execution flow in a Try-Catch block](#execution-flow-in-a-try-catch-block)
- [Throw and the call stack](#throw-and-the-call-stack)
- [Exception Types and Hierarchies](#exception-types-and-hierarchies)
- [Custom Exception Classes](#custom-exception-classes)
- [Throwable and Inherited Methods](#throwable-and-inherited-methods)
